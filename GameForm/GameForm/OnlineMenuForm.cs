    ...
    public class OnlineMenuForm : Form
    {
        ...
        private void StartAsHost()
        {
            try
            {
                ...
                // ✅ ИСПРАВЛЕНИЕ: Ожидаем закрытия лобби и проверяем результат
                ...
                {
                    // Лобби закрылось с ошибкой или было отменено
        ...
        private void StartAsClient()
        {
            try
            {
                ...
                // ✅ ИСПРАВЛЕНИЕ: Пробуем подключиться с таймаутом
                NetworkManager network = null;
                bool connected = false;

                // Запускаем подключение в отдельном потоке с таймаутом
